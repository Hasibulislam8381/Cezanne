...
@section('content')
    ...
    <div class="page-title text-center">
        <div class="contact_tag1 text-center text-bold">Return Policy</div>
        <hr class="hr_for_all">
    </div>
    {{-- bradcrump end --}}
    <section class="return_policy">
        <div class="container">
            ...
            <div class="privacy_text">We use the information we collect in various ways, including to:
